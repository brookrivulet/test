				...
				<view class="background">
					<view class="news">
						<view class="first">
							...
							<img src="@/static/images/13-1.png" alt="">
						</view>
						<view class="second">
							<img src="@/static/images/13-2.png" alt="">
							<view class="second-text">
								<text>
									为了更好地弘扬和传承雪枫精神，培养有理想有本领有担当的时代新人，在宿州市委、市政府和教育主管部门的大力支持下，2021年9月，宿州二中雪枫中学校区正式建成并投入使用。
								</text>
							</view>
						</view>
						<view class="third">
							<view class="third-text">
								<text>
									雪枫中学将全面贯彻党的教育方针，以“弘扬雪枫精神、传承红色基因”为育人主题，以“办有温度的教育、育有尊严的学生”为办学理念，以“建一流学校、育一流人才” 为办学目标，为培养德智体美劳全面发展的社会主义建设者和接班人而砥砺奋进。
								</text>
							</view>
							<img src="@/static/images/13-3.png" alt="">
						</view>
					</view>
				</view>
			</scroll-view>
		...
		methods: {
			...
			musicPlay(){
				...
				if(this.bgAudioMannager.paused){
					...
					this.bgAudioMannager.autoplay = false;
					// 设置播放音频地址
					this.bgAudioMannager.src = 'http://project.xianyiculture.com/audio_guide/mp3/13_shuren.mp3';
